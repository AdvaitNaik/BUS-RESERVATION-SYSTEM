...
void cancle();//for canceling ticket
...
int main()
{
   ...
   printf("====================================== EXPRESSWAY[MUMBAI-PUNE] ================================================\n\n\n");
    printf("\t\t\t\t\t1- Book Tickets\n");
    printf("\n");
    printf("\t\t\t\t\t2- Cancle Booking\n");
    printf("\n");
...
status_1(trno);
 ...
 char str1[80]="16";
 int seat1,booking=0;
//for counting no of seats and putting in tr1
if(trno == 1)
{
 f1 = fopen("tr1.txt","r+");
 fgets(str1,80,f1);
...
itoa(seat1, str1, 10);
//for counting no of seats and putting in tr1 after update
if(trno == 1)
{
 f1 = fopen("tr1.txt","w");
 fputs(str1,f1);
...
for(i=0; i<booking; i++)//for entering the person name and seat number in the file
{
    ...
    printf("\n");
      ...
      fprintf(a,"%s ",name[number-1]);//Writing name in the file
      fprintf(b,"%s ",tempstr);//Writing seat number in file
...
//for storing selected seat number into File number
...
char numstr[100];
int i=0,j=0,k;
itoa(trno,numstr,10); //char *  itoa ( int value, char * str, int base );
strcat(numstr,".txt");
strcat(tempstr2,numstr);
...
//for storing selected seats names into file status1
...
printf("=========================================== BUS RESERVATION SYSTEM ============================================\n\n\n");
    ...
    j=read_number(trno);
    read_name(trno);
    char tempname[33][10]={"Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty "};
    for(i=0; i<j; i++)
    {
